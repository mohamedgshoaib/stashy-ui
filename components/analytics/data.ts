...
const liveFixedBucketsActual: FixedBucketActual[] = [
  ...
  { id: "fb-phone-installment", spent: 300, transactionCount: 1 },
  {
    ...
    spent: 145,
    transactionCount: 8,
    dailyCumulative: buildDailyCumulative(18, 145, 0.9),
  },
  {
    id: "fb-groceries",
    spent: 160,
    transactionCount: 4,
    dailyCumulative: buildDailyCumulative(18, 160, 0.75),
  },
  {
    id: "fb-transport",
    spent: 200,
    transactionCount: 10,
    dailyCumulative: buildDailyCumulative(18, 200, 0.85),
  },
]
...
const liveMonth_2026_05: LiveMonthAnalysis = withManualBucketCalibration({
  ...
  wholeBudgetCloseout: {
    adjustedBudgetTotal: 6735,
    spentTotal: 4760,
    remainder: 1975,
    manualFixedUnusedTotal: 335,
    manualFixedOverspendTotal: 0,
  ...
  paymentMethods: [
    {
      ...
      major: 0,
      total: 360,
      fixedByType: { manual: 200, recurring: 0, installment: 0 },
    },
    {
      id: "pm2",
      name: "Instapay",
